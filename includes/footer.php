...
<footer class="site-footer">
  <div class="wrap footer-grid">
    ...
    <div class="footer-links-col">
      <span class="footer-label">Səhifələr</span>
      <a href="<?= url('projects.php') ?>">Layihələr</a>
      <a href="<?= url('technologies.php') ?>">Texnologiyalar</a>
      <a href="<?= url('calculator.php') ?>">Qiymət hesabla</a>
    </div>
    <div class="footer-links-col">
      <span class="footer-label">Əlaqə</span>
  ...
  <div class="wrap footer-bottom">
    ...
    <a href="<?= url('admin/login.php') ?>" class="footer-admin">Admin</a>
  </div>
</footer>

<script>window.MIRTECH={whatsapp:<?= json_encode($sc['whatsapp_raw']) ?>,base:<?= json_encode(baseUrl()) ?>};</script>
